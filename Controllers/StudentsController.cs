...
namespace Project.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        public StudentsController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, ProjectContext context, IWebHostEnvironment webHostEnvironment)
        {
